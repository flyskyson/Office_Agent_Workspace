...
def fill_official_template_smart(data, template_file="个体工商户开业登记申请书（模板）.docx"):
    """智能填充官方模板"""
    try:
        ...
        output_file = output_dir / f"{business_name}_官方格式申请书_{timestamp}.docx"
...
def main():
    ...
    # 填充模板
    result = fill_official_template_smart(data)

    if result:
        print("\n" + "=" * 60)
        print("完成！")
        print("请在Word中打开生成的文件检查")
        print("=" * 60)
